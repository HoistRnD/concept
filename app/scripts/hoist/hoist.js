...
(function() {
    define('data', [], function() {
        ...
        data.ModelDefinition = function(modelDefinition) {

        };
        data.defineModel = function(modelDefinition) {
            return new data.ModelDefinition(modelDefinition);
        };
        return data;
    });
    /*!
    ...
    define('bus', ['EventEmitter', 'heir'], function(EventEmitter, heir) {
        var Bus = function() {
    ...
    define('errors/api_key_not_set', [], function() {
    ...
    (function() {
        ...
        if (typeof exports == "object") {
            ...
            define('superagent', ['superagent'], function() {
    ...
    define('auth', ['bus', 'config', 'exceptions', 'superagent', 'lodash'], function(bus, config, exceptions, request, _) {
        var Auth = function() {
        ...
        Auth.prototype.checkStatus = function() {
            if (config.ApiKey === undefined) {
                throw new exceptions.ApiKeyNotSet();
            }
            var self = this;
    ...
    define('notifications/email', ['config', 'exceptions'], function(config, exceptions) {
    ...
    define('notifications', ['notifications/email'],
        function(Email) {
            return {
                Email: Email
            };
    ...
    define('Hoist', ['hoist'], function(hoist) {
